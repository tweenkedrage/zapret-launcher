...
--filter-l3=ipv4 --filter-tcp=80,443,2053,2083,2087,2096,8443 --ipset-exclude="%LISTS%ipset-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude-user.txt" --hostlist="%LISTS%list-custom.txt" --dpi-desync=syndata,multidisorder --new ^
