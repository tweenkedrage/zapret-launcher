...
- Интеграция с **Telegram** через `tg://proxy` ссылки (один клик для настройки);
...
- Редактирование списков (`list-general.txt`, `list-google.txt`);
...
- **Сбои интернета**: мониторинг доступности **30+** популярных сервисов.
