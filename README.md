...
На GitHub имеются **zapret-discord-youtube** и **tg-ws-proxy** отдельно, и лично мне надоело их по отдельности включать, поэтому я решил сделать общий лаунчер куда я объеденил всё в один лаунчер.
