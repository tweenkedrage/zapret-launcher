...
#### Мониторинг:
- **Трафик по процессам**: таблица с разделением на **VPN**/**прямой трафик**, **скорость**, количество **соединений**;
- **Статистика сессии**: **время работы**, **трафик** (`⬆/⬇`), **текущая скорость**, **RTT**.
