...
class Languages:
    ...
    TRANSLATIONS = {
        'Russian': {
            ...
            'diagnostic_general_clear': 'Очистить чат',
            ...
            'diagnostic_zapret_missing': 'Папка zapret_core отсутствует',
            'diagnostic_problems_found': 'Обнаружены проблемы:',
        ...
        'English': {
            ...
            'diagnostic_general_clear': 'Clear chat',
            ...
            'diagnostic_zapret_missing': 'Folder zapret_core missing',
            'diagnostic_problems_found': 'Problems found:',
